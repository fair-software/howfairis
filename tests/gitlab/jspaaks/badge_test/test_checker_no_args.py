...
class TestCheckerNoArgs(Contract):
    ...
    def test_check_checklist(self, mocker):
        with mocker:
            ...
            assert mocked_checker.check_checklist() is True
    ...
    def test_has_citationcff_file(self, mocker):
        with mocker:
            mocked_checker = get_mocked_checker()
            assert mocked_checker.has_citationcff_file() is False
    ...
    def test_has_core_infrastructures_badge(self, mocker):
        with mocker:
            mocked_checker = get_mocked_checker()
            assert mocked_checker.has_core_infrastructures_badge() is True
    ...
    def test_has_pypi_badge(self, mocker):
        with mocker:
            mocked_checker = get_mocked_checker()
            assert mocked_checker.has_pypi_badge() is True
    ...
    def test_has_zenodo_badge(self, mocker):
        with mocker:
            mocked_checker = get_mocked_checker()
            assert mocked_checker.has_zenodo_badge() is True
    ...
    def test_is_on_github_marketplace(self, mocker):
        with mocker:
            mocked_checker = get_mocked_checker()
            assert mocked_checker.is_on_github_marketplace() is False
