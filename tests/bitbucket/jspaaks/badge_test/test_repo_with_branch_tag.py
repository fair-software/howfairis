...
def mocked_repo(mocker):
    with mocker:
        return Repo("https://bitbucket.org/jspaaks/badge-test", branch="0.1.0")
...
class TestRepoWithBranchTag(Contract):
    ...
    def test_raw_url_format_string(self, mocked_repo):
        assert mocked_repo.raw_url_format_string == "https://bitbucket.org/jspaaks/badge-test/raw/0.1.0/{0}"
