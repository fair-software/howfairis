...
def mocked_repo(mocker):
    with mocker:
        return Repo("https://bitbucket.org/jspaaks/badge-test", branch="develop")
...
class TestRepoWithBranchDevelop(Contract):
    ...
    def test_raw_url_format_string(self, mocked_repo):
        assert mocked_repo.raw_url_format_string == "https://bitbucket.org/jspaaks/badge-test/raw/develop/{0}"
