...
def get_repo():
    return Repo("https://github.com/fair-software/repo1", path="mypath")
...
class TestRepoWithPath(Contract):
    ...
    def test_raw_url_format_string(self, mocker):
        with mocker:
            repo = get_repo()
            assert repo.raw_url_format_string == "https://raw.githubusercontent.com/fair-software/repo1/master/mypath/{0}"
