...
def get_repo():
    return Repo("https://gitlab.com/fair-software/repo1", branch="b3f90ec9c2b1be604f482c2d9e46a9aeca3ee45a")
...
class TestRepoWithBranchSHA(Contract):
    ...
    def test_raw_url_format_string(self, mocker):
        with mocker:
            repo = get_repo()
            assert repo.raw_url_format_string == "https://gitlab.com/fair-software/repo1/-/raw/" \
