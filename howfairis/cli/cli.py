...
@click.option("-a", "--apikeys-filename", default=None, type=click.Path(),
              help="Name of the file containing the API keys. The file needs to be present on "
                   "the local system and can include a relative path.")
...
def cli(url=None, branch=None, user_config_filename=None, repo_config_filename=None, path=None,
    ...
    * https://gitlab.com (not including any self-hosted instances)
    ...
    checker = Checker(repo, user_config_filename=user_config_filename, repo_config_filename=repo_config_filename,
                      ignore_repo_config=ignore_repo_config, is_quiet=quiet, apikeys_filename=apikeys_filename)
